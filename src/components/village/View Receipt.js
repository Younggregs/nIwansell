...
import Digital from 'react-activity/lib/Dots';
...
export default class ViewReceipt extends React.Component {
  ...
  async componentWillMount(){
    ...
    try {
      const res = await fetch('https://www.iwansell.com/api/receipt/' + this.props.match.params.transaction_id + '/', {
       headers : {
