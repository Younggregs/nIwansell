...
export default class Trending extends React.Component {
  ...
  async componentWillMount() {
    ...
    try {
      const res = await fetch('http://127.0.0.1:8000/trending/' + this.state.campus_id + '/' + this.trending_url_1 + '/');
    ...
    try {
      const res = await fetch('http://127.0.0.1:8000/trending/' + this.props.campus_id + '/' +  this.trending_url_2 + '/');
    ...
    try {
      const res = await fetch('http://127.0.0.1:8000/trending/' + this.props.campus_id + '/' +  this.trending_url_3 + '/');
    ...
    try {
      const res = await fetch('http://127.0.0.1:8000/trending/' + this.props.campus_id + '/' + this.trending_url_4 + '/');
    ...
    try {
      const res = await fetch('http://127.0.0.1:8000/trending/' + this.props.campus_id + '/' +  this.trending_url_5 + '/');
