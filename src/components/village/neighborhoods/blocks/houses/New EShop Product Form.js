...
async getSubcategory(){
  ...
  try {
    const res = await fetch('http://127.0.0.1:8000/subcategory/' + this.state.category_id);
...
const formInstance = (
 ...
 <Row>
  ...
  <form method="POST" enctype="multipart/form-data" action={"http://127.0.0.1:8000/new_eshop_product/" + this.state.account_id + "/"}>  
  <FormGroup>
