...
export default class FavoriteEShop extends React.Component {
  ...
  async componentWillMount() {
    try {
      const res = await fetch('https://www.iwansell.com/api/favorite_list/2/' + this.props.match.params.profile_id);
         ...
         <Row>  
          ...
          <Row>
            ...
            {this.state.favoritelist.map(item => (
             ...
             <img href={"eshop/" + item.eshop_id }  alt="product-image" src= { `${this.state.media}` } />
