...
async componentWillMount(){
  try {
    const res = await fetch('http://www.iwansell.com/api/about_eshop/' + this.props.eshop_id + '/')
  ...
  async favorite(){
    ...
    try {
      const res = await fetch('http://www.iwansell.com/api/favorite/2/' + this.props.eshop_id + '/', {
